      ...
      <el-form ref="user" :model="user" label-width="150px" label-position="left" :rules="rules" status-icon>
        ...
        <el-form-item label="用户全名 :" prop="fullname"  class="user-item">
          <el-row v-if="editfullname">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="primary"  @click="sure('fullname')">确定</el-button>
            </el-col>
          </el-row>
          <el-row v-else>
            <el-col :span="20">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="danger" @click="editfullname = true">编辑</el-button>
            </el-col>
          </el-row>           
        </el-form-item>
        ...
        <el-form-item label="用户密码 :" prop="password"  class="user-item">
          <el-row v-if="editpassword">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="primary"  @click="sure('password')">确定</el-button>
            </el-col>
          </el-row>
          <el-row v-else>
            <el-col :span="20">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="danger"  @click="editpassword = true">编辑</el-button>
            </el-col>
          </el-row>           
        </el-form-item>
        ...
        <el-form-item label="用户性别 :" prop="fmale"  class="user-item">
          <el-row v-if="editfmale">
            <el-col :span="20">
              <el-select v-model="user.fmale">
               <el-option value="男">男</el-option> 
               <el-option value="女">女</el-option> 
              </el-select>
            </el-col>
            <el-col :span="2" :offset="2">
              <el-button type="primary" @click="editfmale = false">确定</el-button>
            </el-col>
          </el-row>
          <el-row v-else>
            <el-col :span="20">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="danger" @click="editfmale = true">编辑</el-button>
            </el-col>
          </el-row>           
        </el-form-item>
        ...
        <el-form-item label="邮件 :" prop="email"  class="user-item">
          <el-row v-if="editemail">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="primary" @click="sure('email')">确定</el-button>
            </el-col>
          </el-row>
          <el-row v-else>
            <el-col :span="20">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="danger" @click="editemail = true">编辑</el-button>
            </el-col>
          </el-row>           
        </el-form-item>
        ...
        <el-form-item label="手机 :" prop="phone"  class="user-item">
          <el-row v-if="editphone">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="primary" @click="sure('phone')">确定</el-button>
            </el-col>
          </el-row>
          <el-row v-else>
            <el-col :span="20">
            ...
            <el-col :span="2" :offset="2">
              <el-button type="danger" @click="editphone = true">编辑</el-button>
            </el-col>
          </el-row>           
        </el-form-item>
